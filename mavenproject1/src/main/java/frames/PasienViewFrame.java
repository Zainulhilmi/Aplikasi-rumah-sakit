 ...
 * @author New User
 */
public class PasienViewFrame extends javax.swing.JFrame {

    /**
     * Creates new form PasienViewFrame
     */
    public PasienViewFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        viewTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Pasien", "Nama Pasien", "Jenis Kelamin", "Gol Darah", "Umur", "Alamat"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(cariTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    if (barisTerpilih >= 0) {
        int id = (int) viewTable.getValueAt(barisTerpilih, 0);
        PasienUbahFrame addFrame = new PasienUbahFrame(id); // Operasi Ubah
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try {
            ...
            String selectSQL = "SELECT * FROM table_pasein";
            ...
            while(resultSet.next()){
                row[0] = resultSet.getInt("kode_pasien");
                row[1] = resultSet.getString("nama_pasien");
                row[2] = resultSet.getString("jenis_kelamin");
                row[3] = resultSet.getString("gol_darah");
                row[4] = resultSet.getString("umur");
                row[5] = resultSet.getString("alamat");
                model.addRow(row);
            }
            koneksi.close();
...
Connection koneksi = basisdata.getConnection();
String selectSQL = "SELECT * FROM table_pasein WHERE nama_pasien like '%"+kataKunci+"%' ";
     	Statement statement = koneksi.createStatement();
     	ResultSet resultSet = statement.executeQuery(selectSQL);
...
model.addRow(row);
   ...
   int barisTerpilih = viewTable.getSelectedRow();
        ...
        int pilihan = JOptionPane.showConfirmDialog(null,
            ...
            if(pilihan == 0){
                try {
                    ...
                    Connection koneksi = basisdata.getConnection();
                    String deleteSQL = "DELETE FROM table_pasein WHERE kode_pasien="+id;
                    Statement statement = koneksi.createStatement();
    ...
    private void tambahButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahButtonActionPerformed
          ...
          PasienAddFrame addFrame = new PasienAddFrame(0); // Operasi Tambah
    addFrame.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PasienViewFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PasienViewFrame().setVisible(true);
            }
        });
    }
